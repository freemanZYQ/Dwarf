...
It was mainly designed to work on Android but later, with a small effort, the support for iOS has been added with ease thanks to the fact they share the same arch.
